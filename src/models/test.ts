...
test('createPictureObj', () => {
  ...
  expect(newPictureObj.width).toEqual(100)
...
test('resizeElement', () => {
  ...
  expect(newProg.currentPresentation.slides[0].elements[0].width).toEqual(newWidth)
  ...
  newHeigth = 20
  newProg = resizeElement(newProg, newWidth, newHeigth)
  expect(newProg.currentPresentation.slides[0].elements[1].width).toEqual(newWidth)
  ...
  newHeigth = 10
  newProg = resizeElement(newProg, newWidth, newHeigth)
  expect(newProg.currentPresentation.slides[0].elements[2].width).toEqual(newWidth)
